...
/*   Updated: 2024/09/28 04:35:24 by mzeggaf          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "New ClapTrap copied from " << clap._name << std::endl;
}
...
ClapTrap &ClapTrap::operator=(const ClapTrap &clap)
{
	...
	std::cout << "New ClapTrap assigned from " << clap._name << std::endl;
	return (*this);
}
